		...
		if servico then
			...
			if distance <= 30.0 then
				...
				if distance <= 2.5 then
					if IsControlJustPressed(0,38) and emP.checkPermission() then
						if IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("voyagepc")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("corollapc")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("dusterpc")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("policiatahoe")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("policiataurus")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("policiavictoria")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("police")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("pspp_530d")) then
							RemoveBlip(blips)
