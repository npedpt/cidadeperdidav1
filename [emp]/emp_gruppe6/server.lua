...
AddEventHandler('vrp_gruppe6:checkcaixa', function(id)
	...
	if user_id then
		if timers[id] == 0 or not timers[id] then
			...
			TriggerClientEvent("Notify",source,"aviso","O <b>Caixa Eletronico</b> foi restaurado a pouco tempo, aguarde <b>"..vRP.format(parseInt(timers[id])).." segundos</b> até que precise de um <b>reabastecimento</b>.")
		end
	end
end)