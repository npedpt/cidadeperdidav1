...
local payment = 30
-----------------------------------------------------------------------------------------------------------------------------------------
-- LOCALIDADES linha 10 tinha bug na favela
-----------------------------------------------------------------------------------------------------------------------------------------
local locs = {
	...
	[10] = { ['x'] = 1260.24, ['y'] = -588.15, ['z'] = 68.53, ['xp'] = 1245.65, ['yp'] = -576.43, ['zp'] = 69.52, ['h'] = 193.0 },
...
Citizen.CreateThread(function()
	while true do
		...
		if emservico then
			...
			if distance <= 50.0 and IsVehicleModel(vehicle,GetHashKey("ambulance")) or IsVehicleModel(vehicle,GetHashKey("ambulancei")) then
