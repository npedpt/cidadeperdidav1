		...
		function pushVehicle(){
            ...
            if (nomeVeiculo != undefined) {
                for	(var i = 0 ; i < 1 ; i++) {
                    ...
                    } else if (idVeh >= 800 && idVeh <=999){
					var eachVeh = $("#MockEachTruck").find('li').clone().removeClass('mock');
                        eachVeh.attr('vehicle-id',idVeh);
                        eachVeh.find('.vehicle-name').find('strong').html(capitalize(nomeVeiculo));
                        eachVeh.find('.car-img').attr('src',imagemVeiculo);
                        eachVeh.find('.vehicle-price').find('strong').html("$"+precoVeiculo);
                        ...
                        $('.trucks-frame').find('.vehicle-list').append(eachVeh);
                    } else if (idVeh >= 1000){
					var eachVeh = $("#MockEachImport").find('li').clone().removeClass('mock');
                        eachVeh.attr('vehicle-id',idVeh);
                        eachVeh.find('.vehicle-name').find('strong').html(capitalize(nomeVeiculo));
                        eachVeh.find('.car-img').attr('src',imagemVeiculo);
                        eachVeh.find('.vehicle-price').find('strong').html("$"+precoVeiculo);
                        ...
                        $('.import-frame').find('.vehicle-list').append(eachVeh);
                    }
                }
            }
		}
