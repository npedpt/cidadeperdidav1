TokoVoipConfig = {
	...
	keySwitchChannels = Keys["HOME"], -- Keybind used to switch the radio channels
	...
	plugin_data = {
		...
		TSServer = "ts.cidadeperdida.tk", -- TeamSpeak server address to be displayed on blocking screen
