...
Citizen.CreateThread(function()
	while true do
		...
		SetDiscordAppId(708092299287986209)--https://discordapp.com/api/webhooks/702604111526494209/HvVfUXc_S5-0jkHcB9U29z4GNhT1xiEnhXi3tCdMP0VQDXEINn7KVKSsP2BCqGDcHvrB
		SetDiscordRichPresenceAsset('logo')
        SetRichPresence("Jogadores Conectados: "..#players)

        SetDiscordRichPresenceAssetText('discord.gg/WUyw4n')
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- BLACKOUT
