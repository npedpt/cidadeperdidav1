...
cfg.dmv = {
  ...
  menu = {
    ...
    scale = 0.4,
    font = 0,
    menu_title = "Escola de condução",
    menu_subtitle = "Tirar Carta de condução",
    color_r = 0,
    color_g = 128,
    color_b = 255,
  }
...
cfg.practical = {
  ...
  steps = {
	...
	},
    {
	  ...
	  stop = "Faça uma parada rápida e observe a sua ESQUERDA antes de entrar no trânsito",
	  msg = "Ótimo! Agora pegue a direita e escolha sua faixa",
	  area = 2
	},
    {
	...
	},
    {
	  ...
	  msg = "Hora de pegar a estrada, controle sua velocidade e não colida !",
	  area = 3
	},
    {
