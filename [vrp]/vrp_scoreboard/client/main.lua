...
function UpdatePlayerTable(connectedPlayers)
	...
	for k,v in pairs(connectedPlayers) do
		...
		if (v.job == 'Enfermeiro' or v.job == 'Paramedico' or v.job == 'Medico' or v.job == 'Diretor') then
			ems = ems + 1
		elseif (v.job == 'COMANDANTE' or v.job == 'PC' or v.job == 'PF' or v.job == 'PRF' or v.job == 'RECOM' or v.job == 'BOPE' or v.job == 'BPCHQ' or v.job == 'GAM' or v.job == 'BPCHQ' or v.job == 'PMERJ') then
			police = police + 1
		elseif v.job == 'Taxista' or v.job == 'LiderTaxista' then
			taxi = taxi + 1
		elseif (v.job == 'Mecanico' or v.job == 'LosMecanico')then
			mechanic = mechanic + 1
		elseif (v.job == 'Estagiario' or v.job == 'Advogado' or v.job == 'Presidente') then
