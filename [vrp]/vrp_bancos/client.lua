...
function mycb(success, timeremaining) -- FUNÇÃO DO HACKEAR, NÃO MEXA!
	if success then
		...
		print('Falhou')
		TriggerEvent('mhacking:hide')
		TriggerEvent('chatMessage', 'SISTEMA', { 255, 69, 0 }, "Falhou em hackear o sistema do banco.")
	end
end
...
AddEventHandler('vrp_bancos:muitolongelocal', function(robb)
	robbing = false
	TriggerEvent('chatMessage', 'AVISO', { 255, 69, 0 }, "Afastou muito da área, por isso, o roubo foi cancelado.")
	robbingName = ""
	secondsRemaining = 0
	incircle = false
end)
...
AddEventHandler('vrp_bancos:jogadormorreulocal', function(robb)
	robbing = false
	TriggerEvent('chatMessage', 'AVISO', {255, 0, 0}, "Morreu, o roubo foi cancelado.")
	robbingName = ""
	secondsRemaining = 0
	incircle = false
end)
...
AddEventHandler('vrp_bancos:hackermorreulocal', function(robb)
	hackeando = false
	TriggerEvent('mhacking:hide')
	TriggerEvent('chatMessage', 'AVISO', {255, 0, 0}, "Morreu, o processo de invasão foi cancelado.")
	robbingName = ""
	secondsRemaining = 0
	incircle = false
end)
...
AddEventHandler('vrp_bancos:completo', function(reward)
	robbing = false
	TriggerEvent('chatMessage', 'GERENTE DO BANCO', { 255, 69, 0 }, "Aqui está o dinheiro, tem ^2€ " .. reward .. "^0 neste saco.")
	bank = ""
	secondsRemaining = 0
	incircle = false
