...
local cow = { model = "a_c_cow" }
local deer = { model = "a_c_deer" }
local poodle = { model = "a_c_poodle" }
local mtlion = { model = "a_c_mtlion" }
local pig = { model = "a_c_pig" }
local chickenhawk = { model = "a_c_chickenhawk" }
local babyd = { model = "u_m_y_babyd" }
local tranvest_01 = { model = "a_m_m_tranvest_01" }
local fatwhite_01 = { model = "a_f_m_fatwhite_01" }
local fatlatin_01 = { model = "a_m_m_fatlatin_01" }
local m_freemode_01 = { model = "mp_m_freemode_01" }
local f_freemode_01 = { model = "mp_f_freemode_01" }
...
cfg.cloakroom_types = {
	["Fardamento H"] = {
	_config = { permissions = {"hroupa.permissao"} },
	["BR Masculino"] = {
		[1] = {121,0,0},
		[2] = {18,0,0},
		[3] = {127,0,0},
	...
	["Personagem"] = {
		...
		["K9 - mtlion"] = mtlion,
		["K9 - pig"] = pig,
		["K9 - chickenhawk"] = chickenhawk,
		--["Musculado"] = babyd,
		--["Travesti"] = tranvest_01,
		--["Gorda"] = fatwhite_01,
		--["Gordo"] = fatlatin_01,
		["Homem"] = surgery_male,
		["Mulher"] = surgery_female,
	--	["Desbugar H"] = m_freemode_01,
	--	["Desbugar M"] = f_freemode_01,
	},
	["Fardamento PMERJ"] = {
...
["Mecanicos"] = {
  ...
  ["Los Santos"] = {
	_config = { permissions = {"lossantos.permissao"} },
	["Mecânico Masculino"] = {
		[1] = {121,0,0},
		[2] = {18,0,0},
		[3] = {125,0,0},
...
cfg.cloakrooms = {
	...
	{ "Mecanicos",-196.04098510742,-1331.3094482422,30.890403747558 },
	{ "Los Santos",1008.8582763672,-2335.1782226563,35.310928344727 },
