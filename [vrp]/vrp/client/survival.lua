...
Citizen.CreateThread(function()
	while true do
		...
		if nocauteado then
			if timedeath > 0 then
				drawTxt("TEM ~r~"..timedeath.." ~w~SEGUNDOS DE VIDA, CHAME OS PARAMEDICOS",4,0.5,0.93,0.50,255,255,255,255)
			else
				drawTxt("PRESSIONE ~g~E ~w~PARA IR PARA O AEROPORTO OU AGUARDE UM PARAMÉDICO",4,0.5,0.93,0.50,255,255,255,255)
			end
