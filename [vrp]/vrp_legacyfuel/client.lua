...
AddEventHandler('vrp_legacyfuel:galao',function()
	GiveWeaponToPed(PlayerPedId(),883325847,200,false,true)
end)
...
AddEventHandler('fuel:refuelFromPump',function(pumpObject,ped,vehicle)
	...
	while isFueling do
		...
		if pumpObject then
			...
			DrawText3Ds(vehicleCoords.x,vehicleCoords.y,vehicleCoords.z + 0.34,"GALÃO: ~b~"..Round(GetAmmoInPedWeapon(ped,883325847) / 200 * 100,1).."%~w~    TANQUE: ~y~"..Round(currentFuel,1).."%")
		end
